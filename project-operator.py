...
def update_custom_field(item_id, field_name, value):
    ...
    # Format value based on dataType from GraphQL API; skip formatting if value is already a properly formatted dict
    if not isinstance(value, dict):
        if data_type == "NUMBER":
            ...
            # Default to TEXT for TEXT type, None, or any other dataType
            value = {"text": value}
